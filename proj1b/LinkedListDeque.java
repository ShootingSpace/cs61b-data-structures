 ...
 * @param <GType>
 */
public class LinkedListDeque<GType> implements Deque<GType> {
    private class OneNode {
        OneNode prev; // sentinel's forward link always points to the last element
        GType item;
        OneNode next; // sentinel's backward link always points to the first element
